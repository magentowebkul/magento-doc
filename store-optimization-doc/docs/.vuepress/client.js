...
const CustomMermaid = {
    ...
    setup(props) {
            ...
            try {
                ...
                mermaid.initialize({
                    ...
                    themeVariables: {
                        ...
                        lineColor: isDark ? "#d3d3d3" : "#333333",
                        textColor: isDark ? "#ffffff" : "#242424",
                ...
                const res = await mermaid.render(uniqueId, decodedCode.value);
                svgCode.value = res.svg;
            } catch (err) {
                console.error("Mermaid render error:", err);
                svgCode.value = `<div style="padding:1rem;color:#ef4444;">Failed to render diagram</div>`;
            }
        };
        ...
        const handlePreview = () => {
            ...
            previewEl.innerHTML = svgCode.value;
        ...
        const handleDownload = () => {
            ...
            a.href = url;
            a.download = `${props.title ? props.title : props.id}.svg`;
        ...
        return () => [
            ...
            h("div", { class: "mermaid-wrapper" }, [
                svgCode.value
                    ? h("div", { class: "mermaid-content", innerHTML: svgCode.value })
                    : h("div", { class: "mermaid-loading", style: { display: "flex", alignItems: "center", justifyContent: "center", height: "96px" } }, "Loading diagram...")
            ])
        ];
    }
};
...
export default defineClientConfig({
    enhance({ app }) {
        ...
        app.component("Mermaid", CustomMermaid);
