...
```
<ExplainCode explanation="This command pulls the Webkul Marketplace Restrict Vendor Product package from your configured Composer repository." />
...
1. Navigate to the module's i18n directory: `app/code/Webkul/RestrictVendorProduct/i18n` (or the equivalent path in your installation).
...
5. Save the file.
6. Upload the translated CSV file to the `app/code/Webkul/RestrictVendorProduct/i18n` path on your server.

![Rename CSV](/images/rvp-rename-the-csv.png)
...
![Locale Option](/images/rvp-locale-option.webp)
