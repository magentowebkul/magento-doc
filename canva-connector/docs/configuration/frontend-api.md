...
| **Canva App Origin** | Text | Auto-calculated | Allowed origin URL for Canva iframes (e.g. `https://app-aahogagcvn4.canva-apps.com`). |
...
CANVA_APP_ID=AAHOGAGCvn4
CANVA_FRONTEND_PORT=8083
CANVA_BACKEND_PORT=3001
CANVA_APP_ORIGIN=https://app-aahogagcvn4.canva-apps.com
