...
const exportAsPdf = async () => {
    ...
    cover.innerHTML = `
      ...
      <div class="meta">
        ...
        <div><strong>Publisher:</strong> Magento 2 ChatGPT Product Review Summary · User Guide</div>
      </div>
    `;
...
const exportAsDocx = async () => {
    ...
    const footer = `
      <footer class="doc-export-footer">
        <p>Document exported from Magento 2 ChatGPT Product Review Summary documentation. URL: ${escapeHtml(window.location.href)} · Generated: ${escapeHtml(stamp)}</p>
      </footer>
    `;
