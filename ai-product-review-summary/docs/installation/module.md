...
```bash
composer require webkul/magento2-ai-productreviewsummary
```

## From a downloaded archive

If you bought the extension from the
[Webkul Store](https://store.webkul.com/magento2-ai-product-review-summary.html), unzip it
and copy the files into `app/code/Webkul/AIProductReviewSummary/`:
...
Create the `Webkul` and `AIProductReviewSummary` folders yourself if they do not exist.
